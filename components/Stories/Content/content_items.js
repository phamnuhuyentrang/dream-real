            ...
            <View style={styles.content5}>
                ...
                <View>
                    <View style={styles.content7}>
                        ...
                        <TouchableOpacity>
                            <FontAwesome5Icon color='white' name="comment-alt" regular size={12} style={styles.commenticon}>
                                <Text style={styles.item8}> {item.number_comment} comments</Text>
                            </FontAwesome5Icon>
                        </TouchableOpacity>
                    </View>
                </View>
...
const styles = StyleSheet.create({
    ...
    item7: {
        width: 40 * screen.width / figma_screen_w,
        height: 40 * screen.width / figma_screen_w,
        marginHorizontal: 5
    },
    content2: {
