    ...
    return (
        <View style={styles.container}>
            <View style={styles.content}>
                {user_item.loginned ? <TouchableOpacity onPress={() => navigation.navigate("Profile")}><Image source={{uri: global.image_host_url + user_item.avatar}} style={styles.avatar}></Image></TouchableOpacity> :
                <TouchableOpacity  onPress={() => user_item.setLogin(!user_item.login)}><View style={styles.avatar} ><FontAwesome5Icon name="user-circle" size={25} solid color='white'></FontAwesome5Icon></View></TouchableOpacity>}
